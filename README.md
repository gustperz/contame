...
- **Tarjeta de crédito**: marca una cuenta como tarjeta de crédito en Ajustes. Lo que compres con ella queda **pendiente** (no suma al mes) hasta que pagues la tarjeta: `pagué la tarjeta 318 mil desde bogotá`. El pago se reparte sobre las compras pendientes de la más antigua a la más nueva, y lo cubierto entra como gasto del mes del pago en su categoría original. `televisor 900 mil a 12 cuotas con tarjeta` guarda las cuotas; el saldo baja a medida que pagas. Pregunta `cuánto debo de la tarjeta`. La deuda anterior a la app se pone en la cuenta y los primeros pagos la cubren sin contar como gasto.
